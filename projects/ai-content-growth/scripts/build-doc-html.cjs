...
const DOCS = [
  {
    src: 'PRD-AI出海内容增长助手-Agent.md',
    out: 'PRD-AI出海内容增长助手-Agent.html',
    title: 'PRD：AI出海内容增长助手 Agent',
    tag: '产品需求文档',
  },
  {
    src: 'full-solution.md',
    out: 'full-solution.html',
...
for (const doc of DOCS) {
  const source = fs.readFileSync(path.join(docsDir, doc.src), 'utf8');
  ...
  fs.writeFileSync(path.join(docsDir, doc.out), html, 'utf8');
